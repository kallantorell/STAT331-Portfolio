...
#https://ggplot2.tidyverse.org/reference/scale_viridis.html I used this website to explore the scale viridis theme and color set, and the various options for it + syntax
```
