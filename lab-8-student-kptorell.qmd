...
```{r}
#| label: rescale-column-test continued
...
```{r}
#| label: Plot parameter extra
penguin_bill_vars <- penguins |>
  dplyr::select(contains("bill"))

penguin_bill_vars
# revised but this was just an extra parameter I wanted to maybe test in the plots or somehow make a plot out of it
```
