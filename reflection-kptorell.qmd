...
#| Challenge 4: Childcare Prices Problem 0
...
numeric_penguin_vars <- penguins |>
  dplyr::select(bill_length_mm, bill_depth_mm, flipper_length_mm, body_mass_g)

penguin_means <- numeric_penguin_vars |>
  purrr::map_dbl(~ mean(.x, na.rm = TRUE))

penguin_means

#revision: extended thinking on rescaling a column 
...
After the midterm portfolio meeting I realized when it came to growing as a data analyst, I was behind a majority of the class. This lit a fire under me and made me start to think about "what am I not considering" or "what context am I not grasping" with the assignments we had the rest of the quarter, as well as past assignments. I started to think about the next step or what other questions could be asked following a coding problem in labs, or think about what exactly is the context and usage of inputs in the code I am submitting. Challenge 7 displayed this well as I incorporated multiple input checks into my code and really dove into creating functions in R. I also went back and looked at previous assignments and thought about previous code chunks, such as the teacher evals in Lab 3. I thought about further questions that could be asked about teacher ratings, like how many teachers received at least 1 highly rated course. I also thought about the data cleaning in that lab, where after cleaning we could view which data was excluded and why we would exclude it.
...
As a peer collaborator, I struggled in the first couple PA's because I did not allow my collaborators to think through problems themselves. I often jumped in too fast to help or filled in code segments for them without discussing it. However, after a few weeks, I felt much more at ease trusting my collaborating partners, and was able to sit back and let them think when they were the coder, which I believe helped them to allow me to think through things myself and grow as a coder as well.

After the last few weeks as a collaborator, I believe I have grown a lot with understanding the paired programming activities. It was not only a learning experience it was for my partner, but just as much for me as a group member and in a way just a test of patience. Maybe I did have an answer or coding solution that was better than theirs but it would not be fair to jump in and take away their learning opportunity. In the same sense, maybe they had a solution that was better than mine, but allowed me to learn from my mistakes and grow as a data analyst and R coder. My groups began to consistently finish labs in time, and the experience became a lot more positive and friendly when my partner or partners coexisted better as a group and learned together.
